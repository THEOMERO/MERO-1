...
send(msg.chat_id_, msg.id_,'⁂︎┇عدد اعضاء المجموعه اقل من *~ {'..(database:get(bot_id..'MERO:Num:Add:Bot') or 0)..'* عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
...
database:set(bot_id.."MERO:Private:Group:Link"..msg.chat_id_,LinkGp) 
