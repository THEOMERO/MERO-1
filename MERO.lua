...
elseif database:sismember(bot_id..'Manager'..chat_id, user_id) then
var = database:get(bot_id.."Manager:Rd"..msg.chat_id_) or 'المدير⁂︎'  
elseif database:sismember(bot_id..'Mod:User'..chat_id, user_id) then
var = database:get(bot_id.."Mod:Rd"..msg.chat_id_) or 'الادمن⁂︎'  
elseif database:sismember(bot_id..'Special:User'..chat_id, user_id) then  
...
send(msg.sender_user_id_, msg.id_,'⁂︎️| تم ارسال رسالتك\n⁂︎| سيتم رد في اقرب وقت')
...
if text == 'تفعيل التواصل ⁂︎' and SudoBot(msg) then  
...
if text == 'تعطيل التواصل ⁂︎️' and SudoBot(msg) then  
...
if text == 'تفعيل البوت الخدمي ⁂︎' and SudoBot(msg) then  
...
if text == 'تعطيل البوت الخدمي ⁂︎' and SudoBot(msg) then  
...
if text == 'تحديث السورس ⁂︎' and SudoBot(msg) then 
os.execute('rm -rf MERO.lua')
os.execute('wget https://raw.githubusercontent.com/MEROBOOT/MERO/master/MERO.lua')
send(msg.chat_id_, msg.id_,'🔭| تم تحديث البوت \n⁂︎| لديك اخر اصدار سورس ميرو\n⁂︎| الاصدار ← { 1.2v}')
dofile('MERO.lua')  
end
if text == 'الاصدار ⁂︎' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'⁂︎| اصدار سورس ميرو \n⁂︎| الاصدار ←{ 1.2v}') 
end
if text == "ضع اسم للبوت ⁂︎" and SudoBot(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_,"⁂︎¦ ارسل لي الاسم الان ")  
return false
end
if text == 'الاحصائيات ⁂︎' and SudoBot(msg) then 
...
if text == 'المشتركين ⁂︎' and SudoBot(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n⁂︎| المشتركين←{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'المجموعات ⁂︎' and SudoBot(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n⁂︎| المجموعات←{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ⁂︎") and SudoBot(msg) then
...
if text == ("قائمه العام ⁂︎") and SudoBot(msg) then
...
if text=="اذاعه خاص ⁂︎" and msg.reply_to_message_id_ == 0 and SudoBot(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"⁂︎¦ ارسل لي سواء >> { ملصق, متحركه, صوره, رساله }\n⁂︎¦ للخروج ارسل الغاء ") 
return false
end 
if text=="اذاعه ⁂︎" and msg.reply_to_message_id_ == 0 and SudoBot(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"⁂︎¦ ارسل لي سواء >> { ملصق, متحركه, صوره, رساله }\n⁂︎¦ للخروج ارسل الغاء ") 
return false
end  
if text=="اذاعه بالتوجيه ⁂︎" and msg.reply_to_message_id_ == 0  and SudoBot(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"⁂︎| ارسل لي التوجيه الان") 
return false
end 
if text=="اذاعه بالتوجيه خاص ⁂︎" and msg.reply_to_message_id_ == 0  and SudoBot(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"⁂︎| ارسل لي التوجيه الان") 
return false
end 
if text == 'جلب نسخه البوت ⁂︎' and SudoBot(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ⁂︎️" and SudoBot(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ⁂︎️" and SudoBot(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if #group == i then 
if (w + q) == 0 then
send(msg.chat_id_, msg.id_,'⁂︎| لا يوجد مجموعات وهميه في البوت\n')   
else
local MERO = (w + q)
...
send(msg.chat_id_, msg.id_,'⁂︎¦ عدد المجموعات الان » { '..#group..' }'..MEROk..''..MERO..'\n*⁂︎| الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
usertext = '\n⁂︎| العضو » ['..result.title_..'](t.me/'..(username or 'MERO170')..')'
status  = '\n⁂︎| تم ترقيته مطور في البوت'
...
usertext = '\n⁂︎| العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'MERO170')..')'
status  = '\n⁂︎| تم ترقيته مطور في البوت'
...
send(msg.chat_id_, msg.id_,"⁂︎¦ تمت الاذاعه الى >>{"..#list.."} مجموعه في البوت ")     
database:del(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_,"⁂︎¦ تمت الاذاعه الى >>{"..#list.."} مجموعات في البوت ")     
database:del(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end 
end
...
send(msg.chat_id_, msg.id_,'⁂︎| عذا لا يمكنك وضع معرف مجوعه في الاشتراك ') 
return false  end
...
send(msg.chat_id_, msg.id_,'⁂︎| البوت ليس ادمن في القناة يرجى ترقيته ادمن ثم اعادة المحاوله ') 
end
return false  
end
end,nil)
...
send(msg.chat_id_, msg.id_,'⁂︎| تم تغيير رسالة الاشتراك بنجاح ')
end
...
send(msg.chat_id_,0,"⁂︎¦العضو : {["..data.first_name_.."](T.ME/MERO170)}\n⁂︎¦["..MERO_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0, "⁂︎|عذرا يا » {[@"..data.username_.."]}\n⁂︎|  الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
else
send(msg.chat_id_,0, "⁂︎|عذرا يا » {["..data.first_name_.."](T.ME/MERO170)}\n⁂︎| الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⁂︎|عذرا يا » {[@"..data.username_.."]}\n⁂︎| الصوره التي ارسلتها تم منعها من المجموعه \n" ) 
else
send(msg.chat_id_,0,"⁂︎|عذرا يا » {["..data.first_name_.."](T.ME/MERO170)}\n⁂︎| الصوره التي ارسلتها تم منعها من المجموعه \n") 
end
end,nil)   
...
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⁂︎|عذرا يا » {[@"..data.username_.."]}\n⁂︎| المتحركه التي ارسلتها تم منعها من المجموعه \n") 
else
send(msg.chat_id_,0,"⁂︎|عذرا يا » {["..data.first_name_.."](T.ME/MERO170)}\n⁂︎| المتحركه التي ارسلتها تم منعها من المجموعه \n" ) 
end
end,nil)   
...
send(msg.chat_id_, msg.id_,'⁂︎¦ عدد اعضاء المجموعه قليله يرجى جمع >> {'..(database:get(bot_id..'Num:Add:Bot') or 0)..'} عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,'⁂︎¦ المجموعه تم تفعيلها من قبل')
else
sendText(msg.chat_id_,'\n⁂︎| بواسطه ← ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n⁂︎|  تم تفعيل المجموعه {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
send(msg.chat_id_, msg.id_,'⁂︎¦ المجموعه تم تطيلها من قبل')
else
sendText(msg.chat_id_,'\n⁂︎| بواسطه ← ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n⁂︎| تم تعطيل المجموعه {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,'⁂︎| تم تفعيل المجموعه بنجاح')
else
...
send(msg.chat_id_, msg.id_,'⁂︎¦ تم تعيين عدد الاعضاء سيتم تفعيل المجموعات التي اعضائها اكثر من  >> {'..Num..'} عضو')
end
...
if text == "حذف رساله الاشتراك ⁂︎" and SudoBot(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, "⁂︎| تم مسح رساله الاشتراك ") 
return false  
end
if text and text:match("^وضع قناة الاشتراك ⁂︎$") and SudoBot(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '⁂︎| حسنآ ارسل لي معرف القناة') 
return false  
end
if text == "تفعيل الاشتراك الاجباري ⁂︎" and SudoBot(msg) then  
if database:get(bot_id..'add:ch:id') then
local addchusername = database:get(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_,"⁂︎| الاشتراك الاجباري مفعل \n⁂︎| على القناة » ["..addchusername.."]")
else
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_,"⁂︎| اهلا عزيزي المطور \n⁂︎| ارسل معرف قناتك ليتم تفعيل الاشتراك الاجباري")
end
return false  
end
if text == "تعطيل الاشتراك الاجباري ⁂︎" and SudoBot(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, "⁂︎| تم تعطيل الاشتراك الاجباري ") 
return false  
end
if text == "الاشتراك الاجباري ⁂︎" and SudoBot(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'⁂︎| بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'MERO170')..') \n⁂︎| تـم قفـل التاك بالكتم\n⁂︎| الحاله ←الكتم ')  
end,nil)   
...
dofile('MERO.lua')  
send(msg.chat_id_, msg.id_, '⁂︎| تم تحديث جميع ملفات البوت') 
end 
...
usertext = '\n⁂︎︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'MERO170')..')'
status  = '\n⁂︎︙تم الغاء (الحظر-الكتم) عام من المجموعات'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/MEROBOOT/Files_MERO/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n⁂︎| اهلا بك في متجر ملفات ميرو\n⁂︎| ملفات السورس ↓\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n\n"
local TextE = "\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n⁂︎|  علامة تعني { ✓ } ملف مفعل\n⁂︎| علامة تعني { ✘ } ملف معطل\n⁂︎| قناة سورس ميرو ↓\n".."⁂︎| [اضغط هنا لدخول](t.me/MERO170) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/MEROBOOT/Files_MERO/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('MERO.lua')  
else
send(msg.chat_id_, msg.id_,"⁂︎| عذرا هاذا ملف ليس من ملفات سورس ميرو\n") 
end
return false
end
...
send(msg.chat_id_, msg.id_, '\n⁂︎| تم مسح قائمه المنشئين الاساسين')
return false
end
...
send(msg.chat_id_, msg.id_, '⁂︎|  تم مسح  قائمة الادمنية  ')
end
...
send(msg.chat_id_, msg.id_,'⁂︎| تم تعطيل الرفع من قبل المنشئين') 
return false
end
...
send(msg.chat_id_, msg.id_,'⁂︎| تم تعطيل الطرد من قبل المنشئين') 
return false
end
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
...
send(msg.chat_id_, msg.id_, '\n⁂︎| عذرا لا تستطيع طرد او حظر او كتم او تقييد ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
...
send(msg.chat_id_, msg.id_, '\n⁂︎| عذرا لا تستطيع طرد او حظر او كتم او تقييد ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"⁂︎| عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
send(msg.chat_id_, msg.id_, '\n⁂︎| عذرا لا تستطيع طرد او حظر او كتم او تقييد ( '..Rutba(userid,msg.chat_id_)..' )')
else
...
send(msg.chat_id_, msg.id_, '⁂︎|  تم مسح  قائمة الاعضاء المميزين  ')
end
...
send(msg.chat_id_, msg.id_, '⁂︎| تم مسح جميع المطايه في المجموعه  ')
end
if text == ("تاك للمطايه") and Mod(msg) then
local list = database:smembers(bot_id..'Mote:User'..msg.chat_id_)
t = "\n⁂︎| قائمة مطايه المجموعه \nء┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n⁂︎¦ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'MERO170')..')'
status  = '\n⁂︎| الايدي » `'..result.sender_user_id_..'`\n⁂︎| تم تنزيل العضو مطي في المجموعه\nتعال حبي رجع العربانه لمدير'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, '⁂︎|  تم تنزيل جميع صخل بالمجموعه  ')
end
if text == ("تاك لصخوله") and Mod(msg) then
local list = database:smembers(bot_id..'Sakl:User'..msg.chat_id_)
t = "\n⁂︎| قائمة صخوله المجموعه \nء┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
send(msg.chat_id_, msg.id_, '⁂︎| تم تنزيل جميع جلاب المجموعه  ')
end
if text == ("تاك لجلاب") and Mod(msg) then
local list = database:smembers(bot_id..'Motte:User'..msg.chat_id_)
t = "\n⁂︎| قائمة الجلاب المجموعه \nء┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
send(msg.chat_id_, msg.id_, '⁂︎| تم تنزيل جميع القروده بالمجموعه  ')
end
if text == ("تاك لقروده") and Mod(msg) then
local list = database:smembers(bot_id..'Motee:User'..msg.chat_id_)
t = "\n⁂︎| قائمة القروده المجموعه \nء┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
send(msg.chat_id_, msg.id_, '⁂︎| تم تنزيل جميع البقرات بالمجموعه  ')
end
if text == ("تاك لبقرات") and Mod(msg) then
local list = database:smembers(bot_id..'Bakra:User'..msg.chat_id_)
t = "\n⁂︎| قائمة البقرات المجموعه \nء┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
send(msg.chat_id_, msg.id_, '⁂︎|  تم تنزيل جميع طليان بالمجموعه ')
end
if text == ("تاك لطليان") and Mod(msg) then
local list = database:smembers(bot_id..'Tele:User'..msg.chat_id_)
t = "\n⁂︎| قائمة الطليان المجموعه \nء┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
send(msg.chat_id_, msg.id_, '⁂︎| تم تنزيل جميع زاحف بالمجموعه ')
end
if text == ("تاك لزواحف") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n⁂︎| قائمة الزواحف المجموعه \nء┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
send(msg.chat_id_, msg.id_, '⁂︎| تم تنزيل جميع جريزي بالمجموعه  ')
end
if text == ("تاك لجريذيه") and Mod(msg) then
local list = database:smembers(bot_id..'Jred:User'..msg.chat_id_)
t = "\n⁂︎| قائمة الجريذيه المجموعه \nء┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
if database:get(bot_id..'Lock:kick'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,'⁂︎| تم تعطيل الحظر من قبل المنشئين') 
return false
end
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then
send(msg.chat_id_, msg.id_, '⁂︎️| انا لست محظورا \n') 
return false 
end
database:srem(bot_id..'Ban:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n⁂︎| العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'MERO170')..')'
status  = '\n⁂︎| الايدي » `'..result.sender_user_id_..'`\n⁂︎| تم الغاء حظره من هنا'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
send(msg.chat_id_, msg.id_, '⁂︎¦  تم مسح قائمه المكتومين ')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n⁂︎| العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'MERO170')..')'
status  = '\n⁂︎| الايدي » `'..result.sender_user_id_..'`\n⁂︎| تم رفعه ادمن بالكروب بكل الصلاحيات'
send(msg.chat_id_, msg.id_, usertext..status)
...
send(msg.chat_id_, msg.id_,"⁂︎| تم تفعيل الرابط") 
return false  
end
end
...
send(msg.chat_id_, msg.id_,"⁂︎| تم تعطيل الرابط") 
return false end
end
if text == "الرابط" then 
...
if link then                              
send(msg.chat_id_,msg.id_,'⁂︎| *Link* -\n┉ ┉ ┉  ┉  ┉  ┉  ┉  ┉\n ['..link..']')                          
else                
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..token..'/exportChatInviteLink?chat_id='..msg.chat_id_))
if linkgpp.ok == true then 
linkgp = '⁂︎| *Link* -\n┉  ┉  ┉  ┉  ┉  ┉  ┉\n ['..linkgpp.result..']'
...
GetWelcome = '⁂︎| لم يتم تعيين ترحيب للمجموعه'
end 
...
send(msg.chat_id_, msg.id_,'⁂︎| تم تعين الايدي بنجاح')    
end
...
send(msg.chat_id_, msg.id_,'⁂︎| تم طرده المحذوفين')
end,nil)
end
end
...
send(msg.chat_id_, msg.id_, "⁂︎ | دز نـوع رتـبـه ?\n⁂︎ | {عـضـو -- ممـيـز -- ادمـن -- مـديـر}") 
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n⁂︎| العضو » ['..result.title_..'](t.me/'..(text1[3] or 'MERO170')..')'..'\n⁂︎| تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,'⁂︎| تم مسح رسائلك جميعها'  )  
...
send(msg.chat_id_, msg.id_,'⁂︎|  عدد رسائلك هنا » { '..database:get(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_)..'}' ) 
end 
...
if num > 1000 then 
send(msg.chat_id_, msg.id_,'⁂︎| تستطيع التنظيف ل1000 رساله كحد اقصى') 
return false  
end  
local msgm = msg.id_
for i=1,tonumber(num) do
...
sebd(msg.chat_id_,msg.id_,'⁂︎| تم تغيير اسم المجموعه الى {['..Name..']}')  
end
end,nil) 
end
...
send(msg.chat_id_, msg.id_,"\n⁂︎| تم تنزيل الشخص من الرتب التاليه \n⁂︎| { "..dev..''..crr..''..cr..''..own..''..mod..''..vip.." } \n")
else
send(msg.chat_id_, msg.id_,"\n⁂︎| ليس لديه رتب حتى استطيع تنزيله \n")
end
...
send(msg.chat_id_, msg.id_,'⁂︎| ارسل الرد الذي تريده سواء كان {صوره,فيديو,متحركه,ملصق,بصمه,صوت}')
...
send(msg.chat_id_, msg.id_,'⁂︎| ارسل الكلمه تريد اضافتها')
...
send(msg.chat_id_, msg.id_,'⁂︎| ارسل الكلمه تريد حذفها')
...
send(msg.chat_id_, msg.id_,'⁂︎️| ايديه »(`'..iduser..'`)\n⁂︎| معرفه »('..username..')\n⁂︎| رتبته »('..rtp..')\n⁂︎| تعديلاته »('..edit..')\n⁂︎| النقاط »('..NUMPGAME..')\n⁂︎| جهاته »('..Contact..')\n📨| رسائله »('..Msguser..')')
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
end
...
local username = ('[@'..data.username_..']' or 'لا يوجد')
local iduser = result.sender_user_id_
send(msg.chat_id_, msg.id_,'⁂︎️| الايدي » ('..iduser..')\n⁂︎| المعرف » ('..username..')\n⁂︎| الرتبه » ('..rtp..')\n⁂︎| نوع الكشف » بالرد')
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
end
...
send(msg.chat_id_, msg.id_,'⁂︎| لا اسطيع صيح معرفات القنوات') 
return false  
end
if result.type_.user_.type_.ID == "UserTypeBot" then
send(msg.chat_id_, msg.id_,'⁂︎| لا اسطيع صيح معرفات البوتات') 
return false  
end
if result and result.type_ and result.type_.channel_ and result.type_.channel_.is_supergroup_ == true then
send(msg.chat_id_, msg.id_,'⁂︎| لا اسطيع صيح معرفات المجموعات') 
return false  
end
if result.id_ then
...
send(msg.chat_id_, msg.id_,'⁂︎| امر صيح تم تعطيله من قبل المدراء ') 
end
return false
end
...
send(msg.chat_id_, msg.id_,'⁂︎| انت منشئ المجموعه ') 
return false
end
...
send(msg.chat_id_, msg.id_,'⁂︎| امر منو ضافني تم تعطيله من قبل المدراء ') 
end
end
...
if Num == 0 then 
Text = '⁂︎| لم تقم بالسحك في الكتابه ليست لديك سحكات'
else
...
Text = '⁂︎| عدد نقاط التي ربحتها هي *» { '..Num..' } نقاطه *'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_, msg.id_, '⁂︎| تم حفظ الكليشه بنجاح')
...
Text = [[
⁂︎| اهلا بك في اوامر البوت  
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
⁂︎| م1 » اوامر الحمايه 
⁂︎| م2 » اوامر تعطيل ~ تفعيل
⁂︎| م3 » اوامر ضع ~ اضف
⁂︎| م4 » اوامر مسح ~ حذف
⁂︎| م5 » اوامر تنزيل + رفع ~ التغير
⁂︎| م6 » اوامر المجموعه
⁂︎| م6 » اوامر التحشيش
⁂︎| م8 » اوامر مطور البوت
⁂︎| م9 » اوامر مطور الاساسي
⁂︎| م10 » اوامر الاعضاء
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
⁂︎| CH » @MERO170
]]
...
t =[[
⁂︎| رابط الحذف التلي ،
⁂︎| فـكـر قـبـل لاتـسـرع .
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
⁂︎ | [اضغط هنا للحذف الحساب](https://telegram.org/deactivate)
]]
send(msg.chat_id_, msg.id_,t) 
return false
end
