...
sudo_users = {SUDO,697510662,1216110209}   
...
send(msg.chat_id_, msg.id_,'✸∫  عدد الكروبات الان » { '..#group..' }'..MEROk..''..MERO..'\n*✸∫  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if MERO1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✸∫ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'BOBBW')..') \n ✸∫ '..MERO1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0, " ✸∫ عذرا » {["..data.first_name_.."](T.ME/BOBBW)}\n ✸∫ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ✸∫ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'BOBBW')..') \n ✸∫ تـم قفـل الدردشه ')
end,nil)   
...
send(msg.chat_id_, msg.id_," ✸∫ عذرا الملف لايدعم سورس ميرو \n") 
end
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ✸∫ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BOBBW')..')'
status  = '\n ✸∫ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ✸∫ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ✸∫ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BOBBW')..')'
...
-- vardump(data) 
MEROdx(msg.chat_id_, msg.id_, ' ✸∫ ايدي المجموعة » ( '..msg.chat_id_..' )\n ✸∫ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ✸∫ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ✸∫ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
