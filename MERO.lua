...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/MEROTEAM/Files_poyka/master/File_Bot/commands.lua") 
...
if text == 'تعطيل التواصل ⁂︎' and SudoBot(msg) then  
...
if text == ("قائمه الكتم العام ⁂︎") and SudoBot(msg) then
...
if text == 'جلب نسخه الاحتياطيه ⁂︎' and SudoBot(msg) then 
GetFile_Bot(msg)
end
...
if #group == i then 
if (w + q) == 0 then
send(msg.chat_id_, msg.id_,'⁂︎︙لا يوجد مجموعات وهميه \n')
else
local MERO = (w + q)
...
local MERO1_Msg = database:get(bot_id.."MERO1:Add:Filter:Rp2"..text..msg.chat_id_)   
if MERO1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'⁂︎︙العضو ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'MERO170')..') \n⁂︎︙'..MERO1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0, "⁂︎︙عذرا » {["..data.first_name_.."](T.ME/MERO170)}\n⁂︎︙عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_, msg.id_,'⁂︎︙بالتأكيد تم تفعيل المجموعه')
else
...
send(msg.chat_id_, msg.id_,'⁂︎︙بالتأكيد تم تعطيل المجموعه')
else
...
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,'⁂︎︙تم تفعيل المجموعه')
else
sendText(msg.chat_id_,'\n⁂︎︙بواسطه ← ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n⁂︎︙تم تفعيل المجموعه {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
database:sadd(bot_id..'Chek:Groups',msg.chat_id_)  
...
os.execute('rm -rf MERO.lua')
os.execute('wget https://raw.githubusercontent.com/MEROTEAM/MERO/master/MERO.lua')
send(msg.chat_id_, msg.id_,'⁂︎︙تم تحديث البوت \n⁂︎︙لديك اخر اصدار سورس ميرو\n⁂︎︙الاصدار ← { 1.2v}')
dofile('MERO.lua')  
end
...
send(msg.chat_id_, msg.id_,"⁂︎︙عذرا الملف لايدعم سورس ميرو \n") 
end
return false
end
...
send(msg.chat_id_, msg.id_, '⁂︎︙تم تنزيل جميع صخوله من المجموعه')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n⁂︎︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'MERO170')..')'
local  statuss  = '\n⁂︎︙تم رفع حصان في المجموعه\n⁂︎︙تعال حبي احطلك سرج وركبك فرني فره حلوه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:set(bot_id.."MERO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."MERO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"⁂︎︙ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."MERO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."MERO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."MERO1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."MERO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
...
local test = database:get(bot_id.."MERO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."MERO1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."MERO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"⁂︎︙ارسل الكلمه الان")  
database:set(bot_id.."MERO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."MERO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."MERO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."MERO1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."MERO1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
t = "\n⁂︎︙قائمة المنع \n… … … … … … … … … … …\n"
for k,v in pairs(list) do  
local MERO_Msg = database:get(bot_id.."MERO1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..MERO_Msg.."}\n"    
end  
if #list == 0 then  
...
send(msg.chat_id_, msg.id_,'⁂︎︙تم ازالة الرد العام')
...
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '⁂︎︙اسم البوت ← '..(database:get(bot_id..'Name:Bot') or 'ميرو')..'\n'..'⁂︎︙عدد المجموعات ← {'..Groups..'}'..'\n⁂︎︙عدد المشتركين ← {'..Users..'}'
send(msg.chat_id_, msg.id_,Text) 
end
return false
end
...
if MERO1_Msg then    
send(msg.chat_id_, msg.id_,"⁂︎︙"..MERO1_Msg)
