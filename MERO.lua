...
if text == 'حذف كليشه ستارت ⁂︎️' and SudoBot(msg) then 
...
if text=="اذاعه بالتثبيت ⁂︎" and msg.reply_to_message_id_ == 0 and SudoBot(msg) then 
...
if text == "تنظيف المشتركين ⁂︎" and SudoBot(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ⁂︎" and SudoBot(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
usertext = '\n⁂︎| العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'MERO170')..')'
status  = '\n⁂︎| تم الغاء حظره عام من المجموعات'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
return false
endif text and text:match("^كتم عام @(.*)$")  and SudoBot(msg) then
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n⁂︎︙لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'MERO170')..')'
status  = '\n⁂︎︙تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n⁂︎︙العضو » '..userid..''
...
database:del(bot_id..'Set:Text:Dev:Bot'..msg.chat_id_)
send(msg.chat_id_, msg.id_,'⁂︎| تم حفظ كليسه المطور')
return false
end
...
⁂︎︙`#username` ~⪼ اسم المستخدم
⁂︎︙`#msgs` ~⪼ عدد رسائل المستخدم
⁂︎︙`#photos` ~⪼ عدد صور المستخدم
⁂︎︙`#id` ~⪼ ايدي المستخدم
⁂︎︙`#auto` ~⪼ تفاعل المستخدم
⁂︎︙`#stast` ~⪼ موقع المستخدم 
⁂︎︙`#edit` ~⪼ عدد السحكات
⁂︎︙`#game` ~⪼ النقاط
]]
send(msg.chat_id_, msg.id_,Text)
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'ميرو').." غادر" or text == 'بوت غادر' then  
...
local amer = '⁂︎︙عدد الادمنيه : '..data.administrator_count_..
...
send(msg.chat_id_,0,'⁂︎¦ تم التعديل على الميديا \n\n⁂︎¦ الشخص الي قام بالتعديل\n➺➺➺ •⊱{ '..users..' }⊰•') 
end,nil)
